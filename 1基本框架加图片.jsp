...
<body>
	...
	<!-- start header -->
	<!-- <div id="contex"> -->
	<!-- section html5標籤，是區塊標籤，範圍比div更大一些 -->
	<section>
		<div id="cleft">
			<nav>
				<ul>
			...
			<article>
			 ...
			 -->
				<div style="text-align: center; width: 100%;">
					...
					<source type="audio/mp3"  src="//music.163.com/outchain/player?type=2&id=371362&auto=1&height=66">
				</audio> -->
				</div>
				...
				figcaption 圖表的說明 -->
				<figure>
					<img alt="" src="http://itstudy.co.jp/upload/js1.jpg" width="400">
					<figcaption>教室圖片1</figcaption>
				</figure>
				<figure>
					<img alt="" src="http://itstudy.co.jp/upload/js2.jpg" width="400">
					<figcaption>教室圖片2</figcaption>
				</figure>
			</article>
		</div>
	</section>
